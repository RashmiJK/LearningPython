...
def analyze_text(filename):
    """Calculate the number f lines and characters in a file
...
class TextAnalysisTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.filename, 'w') as f:
            f.write('Now we are engaged in a great cic=vil war.\n'
                    'testing whether that nation,\n'
                    'or any nation so conceived and so dedicated,\n'
                    'can long endure.')

    def tearDown(self):
        """Fixture that deletes th files used by the test methods."""
        try:
